...
function Map() {
    ...
    const [isActiveRS00, setIsActiveRS00] = useState(false);
    const [isActiveRS01, setIsActiveRS01] = useState(false);

    const handlePathClick = (event, pathId) => {
        console.log(`Clicked on path ${pathId}`);
        if (pathId === 'RS-00') {
            setIsActiveRS00(!isActiveRS00);
            setIsActiveRS01(false);
        } else if (pathId === 'RS-01') {
            setIsActiveRS01(!isActiveRS01);
            setIsActiveRS00(false);
        }
    };
        ...
        <div className="m-auto">
            <svg
                ...
                <path
                    ...
                    id="RS-00" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-00' || isActiveRS00 ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-00')}
                    onMouseOver={() => handlePathHover('RS-00')}
                ...
                <path
                    ...
                    id="RS-01" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-01' || isActiveRS01 ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-01')}
                    onMouseOver={() => handlePathHover('RS-01')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-02" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-02' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-02')}
                    onMouseOver={() => handlePathHover('RS-02')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-03" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-03' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-03')}
                    onMouseOver={() => handlePathHover('RS-03')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-04" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-04' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-04')}
                    onMouseOver={() => handlePathHover('RS-04')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-05" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-05' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-05')}
                    onMouseOver={() => handlePathHover('RS-05')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-06" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-06' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-06')}
                    onMouseOver={() => handlePathHover('RS-06')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-07" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-07' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-07')}
                    onMouseOver={() => handlePathHover('RS-07')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-08" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-08' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-08')}
                    onMouseOver={() => handlePathHover('RS-08')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-09" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-09' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-09')}
                    onMouseOver={() => handlePathHover('RS-09')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-10" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-10' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-10')}
                    onMouseOver={() => handlePathHover('RS-10')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-11" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-11' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-11')}
                    onMouseOver={() => handlePathHover('RS-11')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-12" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-12' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-12')}
                    onMouseOver={() => handlePathHover('RS-12')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-13" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-13' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-13')}
                    onMouseOver={() => handlePathHover('RS-13')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-14" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-14' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-14')}
                    onMouseOver={() => handlePathHover('RS-14')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-15" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-15' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-15')}
                    onMouseOver={() => handlePathHover('RS-15')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-16" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-16' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-16')}
                    onMouseOver={() => handlePathHover('RS-16')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-17" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-17' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-17')}
                    onMouseOver={() => handlePathHover('RS-17')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-18" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-18' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-18')}
                    onMouseOver={() => handlePathHover('RS-18')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-19" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-19' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-19')}
                    onMouseOver={() => handlePathHover('RS-19')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-20" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-20' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-20')}
                    onMouseOver={() => handlePathHover('RS-20')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-21" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-21' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-21')}
                    onMouseOver={() => handlePathHover('RS-21')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-22" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-22' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-22')}
                    onMouseOver={() => handlePathHover('RS-22')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-23" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-23' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-23')}
                    onMouseOver={() => handlePathHover('RS-23')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-24" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-24' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-24')}
                    onMouseOver={() => handlePathHover('RS-24')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-25" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-25' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-25')}
                    onMouseOver={() => handlePathHover('RS-25')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-26" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-26' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-26')}
                    onMouseOver={() => handlePathHover('RS-26')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-27" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-27' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-27')}
                    onMouseOver={() => handlePathHover('RS-27')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-28" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-28' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-28')}
                    onMouseOver={() => handlePathHover('RS-28')}
                    onMouseOut={handlePathLeave}/>
                <path
                    ...
                    id="RS-29" 
                    stroke="#A3C8DB"
                    fill={hoveredPath === 'RS-29' ? '#A3C8DB' : '#fff'}
                    onClick={(event) => handlePathClick(event, 'RS-29')}
                    onMouseOver={() => handlePathHover('RS-29')}
                    onMouseOut={handlePathLeave}/>
            </svg>
        </div>
    );
