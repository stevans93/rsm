        ...
        <div className="flex flex-col gap-10">
          <div className="border border-1 border-main w-[350px] items-center p-4 rounded-2xl bg-main shadowBorder">
            ...
            <span className="text-[#fff] text-[16px]">
              {user.title ? user.title : "Korisnik"}
            </span>
          </div>
            ...
            <div
              ...
              <div className="flex items-center gap-5">
                ...
                <div className="flex flex-col">
                  <p
                    className={`text-[24px] ${
                      activeItem === "profile" ? "text-[#fff]" : "text-main"
                    }`}>
                    Profil
                  </p>
                  <span
                    className={`text-[12px] ${
                      activeItem === "profile" ? "text-[#fff]" : "text-spanGray"
                    }`}>
            ...
            <div
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p
                    className={`text-[24px] ${
                      activeItem === "password" ? "text-[#fff]" : "text-main"
                    }`}>
                    Lozinka
                  </p>
                  <span
            ...
            <div
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p
                    className={`text-[24px] ${
                      activeItem === "user" ? "text-[#fff]" : "text-main"
                    }`}>
                    Korisnici
                  </p>
                  <span
                    className={`text-[12px] ${
                      activeItem === "user" ? "text-[#fff]" : "text-spanGray"
                    }`}>
                    Dodavanje Korisnika Platforme
                  </span>
                </div>
              </div>
              <MdArrowForward
            ...
            <div
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <span
                    className={`text-[12px] ${
                      activeItem === "info" ? "text-[#fff]" : "text-spanGray"
                    }`}>
                    Dodavanje Podataka
                  </span>
                </div>
              ...
              <MdArrowForward
                className={`text-3xl arrow ${
                  activeItem === "info" ? "text-[#fff]" : "text-main"
                }`}
              />
            </div>
          </div>
