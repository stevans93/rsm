        ...
        <div>
            <div className='flex flex-col gap-3'>
                <div className='flex flex-col border border-1 border-main py-2 px-3 rounded-2xl bg-main'>
                    <p className='text-[#fff] text-[18px]'>{user.firstName && user.firstName} {user.lastName && user.lastName}</p>
                    <span className='text-[#fff] text-[12px]'>{user.title ? user.title : "Korisnik"}</span>
                </div>

                <div>
                    <div className='mb-3'>
                        <div className={`flex gap-3 justify-between border border-1 border-[#D6D9D9] items-center p-3 rounded-3xl divHover dashboard ${activeItem === 'profile' ? 'bg-main' : ''}`} onClick={() => { handleItemClick('profile'); handleProfileClick(); }}>
                            ...
                            <MdArrowDownward className={`text-3xl arrow ${activeItem === 'profile' ? 'text-[#fff]' : 'text-main'}`}/>
                        </div>
                    </div>
                ...
                <div>
                    <div className='mb-3'>
                        <div className={`flex gap-3 justify-between border border-1 border-[#D6D9D9] items-center p-3 rounded-3xl divHover ${activeItem === 'password' ? 'bg-main' : ''}`} onClick={() => { handleItemClick('password'); handlePasswordClick() }}>
                            <div className='flex items-center gap-3'>
                            ...
                            <MdArrowDownward className={`text-3xl arrow ${activeItem === 'password' ? 'text-[#fff]' : 'text-main'}`}/>
                        </div>
                    </div>
                ...
                <div>
                    <div className='mb-3'>
                        <div className={`flex gap-3 justify-between border border-1 border-[#D6D9D9] items-center p-3 rounded-3xl divHover ${activeItem === 'user' ? 'bg-main' : ''}`} onClick={() => { handleItemClick('user'); handleUserClick() }}>
                            <div className='flex items-center gap-3'>
