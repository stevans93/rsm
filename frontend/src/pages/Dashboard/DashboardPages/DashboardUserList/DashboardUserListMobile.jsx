...
function DashboardUserListMobile({users = []}) {
  ...
  return (
    <div className="mobile">
      <div className="w-full">
        ...
        <div className="mt-[30px] overflow-scroll rounded-xl !bg-[#fff] p-2 shadowBorder">
          <table className=" text-start  text-[14px]">
            <thead>
...
export default DashboardUserListMobile
